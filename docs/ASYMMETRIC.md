...
- [File Format](FILE_FORMAT.md): `v=2` on-disk layout details.
- [Usage and CLI](USAGE.md): command usage and options.
- [Key Management](KEY_MANAGEMENT.md): rotation and handling guidance.
